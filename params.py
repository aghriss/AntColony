...
evaporate = 0.98
step = 5
phero_min = 30 # phero minimal
phero_max = 150 # pheromone maximale

global alpha,beta,ants_count,life_span    
ants_count = 100 # pour chaque colonie (colonie1 noir,colonie2 : vert)
alpha = 1 # importance de pheromone pour colonie1,colonie2
beta = -1 # importance de direction lineaire, negatif pr aller en diagonale, (colonie1,colonie2)
life_span = 100